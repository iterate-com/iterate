...
// TODO: remove all 'any' from this file (some can become unknown)
...
export default function AgentsPage() {
  ...
  const getters: AgentDetailDataGetters = {
    ...
    getReducedStateAtEventIndex: async () => {
      // const result = await trpc.agents.getReducedStateAtEventIndex.query({
      //   estateId,
      //   agentInstanceName: durableObjectName,
      //   agentClassName,
      //   eventIndex,
  ...
  return (
    <>
      <AgentDetailRenderer
        ...
        reducedState={reducedState as any} // TODO: fix this
